...
def main():
    ...
    parser.add_argument(
        "--data_root",
        default=r"C:\Users\HP\Downloads\resc\RESC",
    )
    ...
    train_normal = image_files(root / "train"  / "good")
    test_normal  = image_files(root / "test"   / "good"   / "img")
    test_anomaly = image_files(root / "test"   / "ungood" / "img")
